...
def midprice():
    orderbook_df = pd.read_csv("./orderbook_merge_data/mod_partial_orderbook.csv")
    ...
    result_df.to_csv('./result/midprice_26.csv',sep=',',index=False)
...
def Book_I():
    ...
    result_df.to_csv('./result/book_i_26.csv',sep=',',index=False)
...
def Book_D():
    ...
    result_df.to_csv('./result/book_d_26.csv',sep=',',index=False)
        
            
    
def merge():
    m_df = pd.read_csv("./result/midprice_26.csv")
    i_df = pd.read_csv("./result/book_i_26.csv")
    d_df = pd.read_csv("./result/book_d_26.csv")
    ...
    result_df.to_csv('./result/2022-11-26-upbit-btc-krw-feature.csv',sep=',',index=False)
